...
mod tests {
	...
	fn test_operators() {
		...
		assert_eq!(eval_test("2^0.5"), "1.4142135623730950488016887242097");
		assert_eq!(eval_test("2^-0.5"), "0.70710678118654752440084436210485");
	}
	...
	fn test_convert() {
		fn convert_test(value: &str, unit: Unit, to_unit: Unit) -> f64 {
			...
			let string_result = &result.unwrap().value.to_sci().to_string();
		...
		assert_eq!(convert_test("42195.0", Meter, Marathon), 1.0);
		...
		assert_eq!(convert_test("1000.0", BitsPerSecond, KilobitsPerSecond), 1.0);
		assert_eq!(convert_test("1000.0", KilobitsPerSecond, MegabitsPerSecond), 1.0);
		assert_eq!(convert_test("1000.0", MegabitsPerSecond, GigabitsPerSecond), 1.0);
		assert_eq!(convert_test("1000.0", GigabitsPerSecond, TerabitsPerSecond), 1.0);
		assert_eq!(convert_test("1000.0", TerabitsPerSecond, PetabitsPerSecond), 1.0);
		assert_eq!(convert_test("1000.0", PetabitsPerSecond, ExabitsPerSecond), 1.0);
		assert_eq!(convert_test("1000.0", ExabitsPerSecond, ZettabitsPerSecond), 1.0);
		assert_eq!(convert_test("1000.0", ZettabitsPerSecond, YottabitsPerSecond), 1.0);
		assert_eq!(convert_test("1024.0", BitsPerSecond, KibibitsPerSecond), 1.0);
		assert_eq!(convert_test("1024.0", KibibitsPerSecond, MebibitsPerSecond), 1.0);
		assert_eq!(convert_test("1024.0", MebibitsPerSecond, GibibitsPerSecond), 1.0);
		assert_eq!(convert_test("1024.0", GibibitsPerSecond, TebibitsPerSecond), 1.0);
		assert_eq!(convert_test("1024.0", TebibitsPerSecond, PebibitsPerSecond), 1.0);
		assert_eq!(convert_test("1024.0", PebibitsPerSecond, ExbibitsPerSecond), 1.0);
		assert_eq!(convert_test("1024.0", ExbibitsPerSecond, ZebibitsPerSecond), 1.0);
		assert_eq!(convert_test("1024.0", ZebibitsPerSecond, YobibitsPerSecond), 1.0);
		assert_eq!(convert_test("8.0", BitsPerSecond, BytesPerSecond), 1.0);
		assert_eq!(convert_test("1000.0", BytesPerSecond, KilobytesPerSecond), 1.0);
		assert_eq!(convert_test("1000.0", KilobytesPerSecond, MegabytesPerSecond), 1.0);
		assert_eq!(convert_test("1000.0", MegabytesPerSecond, GigabytesPerSecond), 1.0);
		assert_eq!(convert_test("1000.0", GigabytesPerSecond, TerabytesPerSecond), 1.0);
		assert_eq!(convert_test("1000.0", TerabytesPerSecond, PetabytesPerSecond), 1.0);
		assert_eq!(convert_test("1000.0", PetabytesPerSecond, ExabytesPerSecond), 1.0);
		assert_eq!(convert_test("1000.0", ExabytesPerSecond, ZettabytesPerSecond), 1.0);
		assert_eq!(convert_test("1000.0", ZettabytesPerSecond, YottabytesPerSecond), 1.0);
		assert_eq!(convert_test("1024.0", KibibytesPerSecond, MebibytesPerSecond), 1.0);
		assert_eq!(convert_test("1024.0", MebibytesPerSecond, GibibytesPerSecond), 1.0);
		assert_eq!(convert_test("1024.0", GibibytesPerSecond, TebibytesPerSecond), 1.0);
		assert_eq!(convert_test("1024.0", TebibytesPerSecond, PebibytesPerSecond), 1.0);
		assert_eq!(convert_test("1024.0", PebibytesPerSecond, ExbibytesPerSecond), 1.0);
		assert_eq!(convert_test("1024.0", ExbibytesPerSecond, ZebibytesPerSecond), 1.0);
		assert_eq!(convert_test("1024.0", ZebibytesPerSecond, YobibytesPerSecond), 1.0);
		...
		assert_eq!(convert_test("745.69987158227022", Watt, Horsepower), 1.0);
